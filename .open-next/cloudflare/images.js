...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "http", hostname: "^(?:^(?:www\\.zaocn\\.top)$)$", port: "", pathname: "^(?:\\/uploads(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "http", hostname: "^(?:^(?:zaocn\\.top)$)$", port: "", pathname: "^(?:\\/uploads(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
